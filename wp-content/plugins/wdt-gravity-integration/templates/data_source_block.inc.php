...
<div class="col-sm-6 hidden" id="wdt-gf-form-container">
    <h4 class="c-black m-b-20">
        ...
        <i class="zmdi zmdi-help-outline" data-toggle="tooltip" data-placement="right" title="" data-original-title="Please choose a Gravity Form that will be used as data source for wpDataTable"></i>
    </h4>
...
<div class="col-sm-6 hidden" id="wdt-gf-column-container">
    <h4 class="c-black m-b-20">
        ...
        <i class="zmdi zmdi-help-outline" data-toggle="tooltip" data-placement="left" title="" data-original-title="Please choose form fields that will be used as wpDataTable columns"></i>
    </h4>
