(function ($) {
    $(function () {
        ...
        function activatePlugin() {
            $('#wdt-activate-plugin-powerful').html('Loading...');
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (valid === true && domainRegistered === true) {
                        ...
                        $('#wdt-activate-plugin-powerful').removeClass('btn-primary').addClass('btn-danger').html('Deactivate');
        ...
        function deactivatePlugin() {
            $('#wdt-activate-plugin-powerful').html('Loading...');
            $('#wdt-envato-deactivation-powerful').html('Loading...');
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (parsedResponse.deactivated === true) {
                        ...
                        $('#wdt-activate-plugin-powerful').removeClass('btn-danger').addClass('btn-primary').html('Activate');
                        ...
                        $('#wdt-envato-deactivation-powerful').html('Deactivate').hide()
                        ...
                        $('#wdt-activate-plugin-powerful').html('Deactivate');
                        $('#wdt-envato-deactivation-powerful').html('Deactivate');
                    }
                }
            });
        }
