...
<div class="col-sm-6">
    ...
    <!-- Panel Heading -->
    <p class="wdt-activation-heading"><?php _e('Powerful Filters', 'wpdatatables'); ?></p>
    <!-- /Panel Heading -->
    ...
    <div class="panel-body">
        ...
        <div class="col-sm-10 wdt-purchase-code-powerful">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-sm-1">
                        <button class="btn btn-primary waves-effect" id="wdt-activate-plugin-powerful">
        ...
        <!-- Envato API -->
        <div class="col-sm-10 wdt-envato-activation wdt-envato-activation-powerful">
