...
*/		
		array (
			'key' => 'field_527d5d1cfb84a',
			'label' => __('Phone','psp_projects'),
			'name' => 'cphone',
			'type' => 'text',
			'instructions' => __('Phone of project/client','psp_projects'),
			'default_value' => '',
			'placeholder' => '',
			'prepend' => '',
			'append' => '',
		...
		array (
			'key' => 'field_527d5d1cfb84b',
			'label' => __('Email','psp_projects'),
			'name' => 'cemail',
			'type' => 'text',
			'instructions' => __('Email of project/client','psp_projects'),
			'default_value' => '',
			'placeholder' => '',
			'prepend' => '',
			'append' => '',
		...
		array (
			'key' => 'field_527d5d1cfb84c',
			'label' => __('Localitate','psp_projects'),
			'name' => 'clocalitate',
			'type' => 'text',
			'instructions' => __('Localitate Beneficiar','psp_projects'),
			'default_value' => '',
			'placeholder' => '',
			'prepend' => '',
			'append' => '',
		...
		array (
			'key' => 'field_527d5d1cfb84d',
			'label' => __('Strada','psp_projects'),
			'name' => 'cstrada',
			'type' => 'text',
			'instructions' => __('Strada','psp_projects'),
			'default_value' => '',
			'placeholder' => '',
			'prepend' => '',
			'append' => '',
		...
		array (
			'key' => 'field_527d5d1cfb84g',
			'label' => __('Numar','psp_projects'),
			'name' => 'cnumar',
			'type' => 'text',
			'instructions' => __('Numar','psp_projects'),
			'default_value' => '',
			'placeholder' => '',
			'prepend' => '',
			'append' => '',
		...
		array (
			'key' => 'field_527d5d1cfb84h',
			'label' => __('Bloc','psp_projects'),
			'name' => 'cbloc',
			'type' => 'text',
			'instructions' => __('Bloc','psp_projects'),
			'default_value' => '',
			'placeholder' => '',
			'prepend' => '',
			'append' => '',
		...
		array (
			'key' => 'field_527d5d1cfb84i',
			'label' => __('Scara','psp_projects'),
			'name' => 'cscara',
			'type' => 'text',
			'instructions' => __('Scara','psp_projects'),
			'default_value' => '',
			'placeholder' => '',
			'prepend' => '',
			'append' => '',
		...
		array (
			'key' => 'field_527d5d1cfb84j',
			'label' => __('Etaj','psp_projects'),
			'name' => 'cetaj',
			'type' => 'text',
			'instructions' => __('Etaj','psp_projects'),
			'default_value' => '',
			'placeholder' => '',
			'prepend' => '',
			'append' => '',
		...
		array (
			'key' => 'field_527d5d1cfb84k',
			'label' => __('apartament','psp_projects'),
			'name' => 'capartament',
			'type' => 'text',
			'instructions' => __('Apartament','psp_projects'),
			'default_value' => '',
			'placeholder' => '',
			'prepend' => '',
			'append' => '',
		...
		array (
			'key'	=>	'field_project_addr_judet',
			'label'	=>	__( 'Judet', 'psp_projects' ),
			'name'	=>	'addr_judet',
			'type'	=>	'select',
			'choices' => array (
				'Bucuresti' 	=> 	__( 'Bucuresti', 'psp_projects' ),
				'Ilfov'		=> 	__( 'Ilfov', 'psp_projects' ),
				'Giurgiu'	=>	__( 'Giurgiu', 'psp_projects' ),
			),
			'wrapper' => array(
				'width' => '33'
			)
