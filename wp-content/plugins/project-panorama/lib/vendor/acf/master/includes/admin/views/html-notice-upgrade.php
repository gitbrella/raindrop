...
<div id="acf-upgrade-notice" class="notice">
	...
	<div class="col-content">
		...
		<img src="<?php echo PROJECT_PANARAMA_URI . '/dist/assets/images/panorama-logo.png'; ?>" style="max-width: 200px" />
		<h2><?php _e("Database Upgrade Required",'acf'); ?></h2>
		<p><?php printf(__("Thank you for updating!", 'acf'), acf_get_setting('name'), acf_get_setting('version') ); ?><br /><?php _e("This version contains improvements to your database and requires an upgrade.", 'acf'); ?></p>
	</div>
