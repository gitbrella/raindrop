...
function psp_check_notices() {
    ...
    $addon_reqs = apply_filters( 'psp_addon_reqs', array(
        ...
        'frontend_editor'   =>  array(
            'def'           =>  'PSP_FE_VER',
            'req'           =>  '1.5',
            'message'       =>  esc_html( 'This version of Panorama requires version 1.5 or higher of the Front End Editor add-on.', 'psp_projects' ) . ' <a href="https://www.projectpanorama.com/my-account/" target="_new">' . esc_html( 'Download it here.', 'psp_projects' ) . '</a>'
        ),
        'checklists'    =>  array(
            'def'       =>  'PSP_CHECK_VER',
            'req'       =>  '1.5',
        ...
        'sub_tasks'    =>  array(
            'def'       =>  'PSP_ST_VER',
            'req'       =>  '1.5',
            'message'   =>  esc_html( 'This version of Panorama requires version 1.5 or higher of the Sub Tasks add-on.', 'psp_projects' ) . ' <a href="https://www.projectpanorama.com/my-account/" target="_new">' . esc_html( 'Download it here.', 'psp_projects' ) . '</a>',
        ),
        'gallery'   =>   array(
