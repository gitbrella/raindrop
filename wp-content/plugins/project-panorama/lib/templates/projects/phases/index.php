...
<?php if( $phases || current_user_can('edit_psp_projects') ): ?>
	...
	<hgroup class="psp-section-heading psp-row">
		...
		<div class="psp-h2 psp-section-title"><?php esc_html_e( 'Phases', 'psp_projects' ); ?></div>
...
<div class="<?php echo esc_attr($wrapper_class); ?> psp-phase-wrap psp-total-phases-<?php echo esc_attr(psp_get_phase_count()); ?>">
