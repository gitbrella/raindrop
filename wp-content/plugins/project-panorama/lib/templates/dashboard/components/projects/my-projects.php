...
<div class="psp-archive-section">
	...
	<div class="psp-table-header">
		<div class="psp-sub-nav">
			...
			<div class="psp-sub-nav-item"><a href="<?php echo esc_url($active_link); ?>" class="psp-archive-link <?php if( ( get_query_var( 'psp_status_page' ) == 'active' ) || ( !get_query_var( 'psp_status_page' ) ) ) { echo 'active'; } ?>"><?php esc_html_e( 'Active Projects', 'psp_projects' ); ?></a></div>
			<div class="psp-sub-nav-item"><a href="<?php echo esc_url($completed_link); ?>" class="psp-archive-link <?php if( get_query_var( 'psp_status_page' ) == 'completed' ) { echo 'active'; } ?>"><?php esc_html_e( 'Completed Projects', 'psp_projects' ); ?></a></div>
