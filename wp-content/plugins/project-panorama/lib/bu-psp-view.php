...
function psp_get_project_breakdown() {
    ...
    <div class="psp-chart-wrap">
        ...
        <?php do_action( 'psp_before_dashboard_chart', $projects ); ?>

	       <div class="psp-chart">
		        <canvas id="psp-dashboard-chart" width="100%" height="150"></canvas>
	       </div>

           <?php do_action( 'psp_after_dashboard_chart', $projects ); ?>
    ...
    <ul data-pie-id="psp-dashboard-chart" class="dashboard-chart-legend">
     ...
     <ul class="psp-projects-overview">
            ...
            <li><span class="psp-dw-completed" style="color: <?php echo $colors[ 'complete' ]; ?>"><?php echo $completed_projects; ?></span> <strong><?php esc_html_e( 'Completed', 'psp_projects' ); ?></strong></li>
            <li><span class="psp-dw-active" style="color: <?php echo $colors[ 'incomplete' ]; ?>;"><?php echo $active; ?></span> <strong><?php esc_html_e( 'Active', 'psp_projects' ); ?></strong></li>
