...
function psp_fe_edit_documents_link( $post_id ) {
    ...
    if( psp_can_edit_project($cuser->ID) ) { ?>
        <div class="psp-fe-edit-link psp-fe-edit-documents"><a href="<?php echo esc_url( get_post_type_archive_link('psp_projects') . 'manage/edit/' . $post_id . '?section=documents' ); ?>"><i class="fa fa-pencil"></i> <?php esc_html_e( 'Edit Documents', 'psp-front-edit' ); ?></a></div>
    <?php }
...
function psp_fe_edit_project_description_modal() { ?>
    ...
    <div class="psp-modal psp-hide" id="psp-edit-description-modal">
        ...
        <div class="psp-modal-header">
             <div class="psp-h2"><?php esc_html_e( 'Edit Description', 'psp-front-edit'); ?></div>
        </div>
    ...
    <div class="psp-modal psp-hide" id="psp-edit-phases-modal">
        ...
        <div class="psp-modal-header">
             <div class="edit-phase-heading">
                  <div class="psp-h2"><?php esc_html_e( 'Edit Phase', 'psp-front-edit'); ?></div>
             </div>
             <div class="add-phase-heading">
                  <div class="psp-h2"><?php esc_html_e( 'Add Phase', 'psp-front-edit' ); ?></div>
             </div>
        </div>
            ...
            <div class="psp-form-fields">
                ...
                <div class="psp-modal-actions">
                    <div class="pano-modal-add-btn">
                        <input type="submit" class="pano-btn pano-btn-primary" value="<?php esc_attr_e( 'Save', 'psp-front-edit' ); ?>">
                        <a class="modal-close" href="#"><?php esc_html_e( 'Cancel', 'psp-front-edit' ); ?></a>
                        <a class="psp-del-phase-link" href="#" data-confirmation="<?php esc_html_e( 'Are you sure you want to delete this phase?', 'psp-front-edit' ); ?>">
                            <i class="fa fa-trash"></i> <?php esc_html_e( 'Delete', 'psp-front-edit' ); ?>
                        </a>
                   </div>
                </div>
