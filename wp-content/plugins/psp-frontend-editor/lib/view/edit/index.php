...
include( psp_template_hierarchy('dashboard/header') ); ?>
	...
	<?php if( is_user_logged_in() ): ?>
			...
			<?php include( psp_template_hierarchy( 'global/header/masthead' ) ); ?>
                   ...
                   <div class="psp-fe-wizard-wrap">
                       ...
                       if( $editable && psp_can_edit_project($post_id) ): ?>
                           ...
                           <div class="psp-fe-hgroup psp-group">
                               <div class="psp-h2"><?php echo esc_html($title); ?></div>
                               ...
                               <div class="psp-wizard-actions">
                                ...
                                <?php
                                    ...
                                    if( !$editable ): ?>
                                        ...
                                        <div class="psp-p"><?php esc_html_e( 'Sorry, but there doesn\'t appear to be a project with that ID.', 'psp_projects' ); ?></p>
	   ...
	   <?php
        if( $editor_id = psp_check_post_lock($post_id) ):
            $editor = psp_get_nice_username_by_id($editor_id); ?>
            <div class="psp-post-lock-bg"></div>
            <div class="psp-post-lock-alert psp-alert">
                <p><?php echo sprintf( esc_html_x( 'This project is currently being edited by %s', 'Post lock message', 'psp_projects' ), $editor ); ?></p>
            </div>
        <?php
        else:
